...
public class L: Shape
{
    ...
    override public func stepsToDown() -> Int
    {
            ...
            if (moved == 0)
            {
                ...
                {
                    if (StartActivity.logic.getFromArray(squares[3].x, y) == " " &&
            ...
            else if (moved == 1)
            {
                ...
                for ybig in squares[3].y + 1 ..< Logic.height
                {
                    if (StartActivity.logic.getFromArray(squares[3].x, ybig) == " " &&
                            StartActivity.logic.getFromArray(squares[1].x, ymin) == " " &&
                            StartActivity.logic.getFromArray(squares[0].x, ymin) == " ")
                    {
                        count += 1;
                    }
                    else
