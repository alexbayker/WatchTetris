...
public class Z: Shape
{
    ...
    override public func move() -> Bool
    {
        if (moved == 0)
        {
            if (squares[0].x < 9 &&
                squares[0].y > -1 &&
                StartActivity.logic.getFromArray(squares[0].x - 1, squares[0].y) == " " &&
                StartActivity.logic.getFromArray(squares[2].x + 1, squares[0].y) == " ")
            {
                StartActivity.logic.setInArray(squares[1].x, squares[1].y, " ");
                StartActivity.logic.setInArray(squares[3].x, squares[3].y, " ");
    ...
    override public func stepsToDown() -> Int
    {
        ...
        if (moved == 0)
        {
            ...
            for y in squares[3].y + 1 ..< Logic.height
            {
                if (squares[2].y == -2)
                {
                    ...
                    StartActivity.logic.getFromArray(squares[2].x, y1) == " ")
                {
                    count += 1;
                }
                else
        ...
        {
            var y = squares[3].y + 1
            for y1 in squares[2].y + 1 ..< Logic.height
            {
                if (StartActivity.logic.getFromArray(squares[3].x, y) == " " &&
                    StartActivity.logic.getFromArray(squares[2].x, y1) == " " &&
                    StartActivity.logic.getFromArray(squares[0].x, y1) == " ")
                {
                    count += 1;
                }
                else
